...
class RobertaSelfAttention(nn.Module):
    def __init__(self, config, cross=False, layer_index=None):
        super().__init__()
...
class RobertaAttention(nn.Module):
    def __init__(self, config, cross=False, layer_index=None):
        super().__init__()
        self.self = RobertaSelfAttention(config, cross=cross, layer_index=layer_index)
...
class RobertaLayer(nn.Module):
    def __init__(self, config, add_cross=False, layer_index=None):
        super().__init__()
        ...
        if add_cross:
            self.crossattention_t2i = RobertaAttention(config, cross=True, layer_index=layer_index)
